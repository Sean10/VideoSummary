...
- 视频总结
date: 2023-10-04
subtitle: Ceph_Developer_Monthly_2023-10-04
tags:
- Ceph
- 分布式存储
- 测试
title: "CephDeveloperMonthly2023-10-04"
updated: 2023-10-05
---
...
#### 主要议题
1. **审计模块的创建请求（RFE）**
   - **背景**: CephFS团队希望在RADOS中持久化存储审计日志。
   - **当前问题**: 现有的审计日志可能被删除或丢失。
   - **提议解决方案**: 开发新的RADOS管理模块，用于持久化存储审计日志条目。
   - **讨论点**:
     - 用户如何选择需要保存的审计日志。
     - 权限和API设计问题。
     - 保留策略的配置。
