...
- 会议纪要
date: 2023-01-12
subtitle: Ceph_Performance_Meeting_2023-01-12
tags:
- Ceph
- 分布式存储
- RocksDB
...
#### 会议概要
本次会议主要讨论了Ceph存储系统的多个Pull Request（PR），包括优先操作、RocksDB迭代器平衡、删除范围操作的改进等。此外，会议还探讨了未来的研究方向和计划，并对Blue Store中的快照和对象克隆进行了优化讨论。

#### 主要议题
1. **Pull Request讨论**
   - **优先操作PR**：讨论了新的PR，涉及优先操作和插件。
   - **RocksDB迭代器平衡PR**：Corey的PR，关于设置RocksDB迭代器的平衡或集合列表。
...
#### 其他事项
- 讨论了Adam Kupchak在优化快照和对象克隆方面的进展。
- 讨论了使用RocksDB的deadline参数来检测是否有过多的墓碑（tombstones）和迭代时间过长的问题。
