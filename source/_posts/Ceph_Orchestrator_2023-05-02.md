...
- 视频总结
date: 2023-05-03
subtitle: Ceph_Orchestrator_2023-05-02
tags:
- Ceph
- 分布式存储
- Cephadm
...
#### 关键细节：
- **IPv6 问题**：
  - 讨论了 IPv6 地址绑定问题，特别是由于 IPv6 地址需要额外的字段（如 flow info 和 scope ID）导致的绑定失败。
  - 提出了进一步研究如何处理这些字段，特别是 scope ID 的确定方法。
  - 决定将此议题留待后续讨论，以便有更多时间进行深入研究。

- **基于包的 Cephadm 开发**：
  - 讨论了开发一个基于包的管理工具的可能性，以满足那些不希望使用容器化 Ceph 的用户需求。
