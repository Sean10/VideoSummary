...
- Ceph
date: 2022-04-07
subtitle: Ceph_Performance_Meeting_2022-04-07
tags:
- Ceph
- 性能优化
- NVMe
...
#### 关键细节
- **性能问题讨论**：会议重点讨论了Ceph存储系统中的性能问题，特别是关于NVMe驱动器和AVL分配器的行为。
...
#### 讨论的主要议题
- **性能下降原因**：分析了性能下降的可能原因，包括硬件问题或软件配置问题。
...
- **状态分析**：Mark提议在分配器表现不佳时，捕获其状态以进行详细分析。
